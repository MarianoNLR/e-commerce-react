        ...
        <div className="footer-wrapper">
          <div className='footer-social-wrapper'>
            <ul className='social-list'>
              <li className='social-list-item github-logo'><a className='social-list-item-link' href='https://github.com/MarianoNLR' target='_blank'>
              <img src={githubLogo} alt="" className='social-list-item_image'/></a>
              </li>
              {/* <li className='social-list-item'><a className='social-list-item-link' href='' target='_blank'>
